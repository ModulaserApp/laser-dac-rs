...
- [x] **1.1 Update `StreamInstant`** - Add `as_secs_f64(pps: u32) -> f64` method and update docs
...
- [ ] **2.2 Add pre-allocated buffers to `Stream`** - `chunk_buffer` and `last_chunk` sized to `caps.max_points_per_chunk`
